...
class CalculatedSpectralIndex(_Calculated):
    ...
    def from_sts(cls, file: str, detector_name: str, **kwargs):
        ...
        mass_norm = ATOMIC_MASS[kwargs['deposit_ids'][1]] / ATOMIC_MASS[kwargs['deposit_ids'][0]]
    ...
    def from_sts_detectors(cls, file: str, detector_names: dict[str, str], **kwargs):
        ...
        # Serpent detector uncertainty is relative
        u1, u2 = u1_ * v1, u2_ * v2
        v, u = ratio_v_u(_make_df(v=v1 / ATOMIC_MASS[kwargs['deposit_ids'][0]],
                                  u=u1 / ATOMIC_MASS[kwargs['deposit_ids'][0]]),
                         _make_df(v=v2 / ATOMIC_MASS[kwargs['deposit_ids'][1]],
                                  u=u2 / ATOMIC_MASS[kwargs['deposit_ids'][1]]))
        S1, S2= 1 / v2, v1 / v2 **2
